...
3. 만약 {"source": "철수", "target": "영희", "relationship": "친구"}, 
{"source": "영희", "target": "철수", "relationship": "친구"} 처럼 source와 target의 순서만 다르고, relationship은 같다면 두 번 적지 말고 {"source": "철수", "target": "영희", "relationship": "친구"} 한 번만 적으세요.
